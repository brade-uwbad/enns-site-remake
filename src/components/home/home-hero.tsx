    ...
    <section className="relative min-h-[calc(100dvh-var(--site-header-offset))] w-full overflow-hidden">
      ...
      >
        <div className="max-w-xl text-white">
          <p className="text-sm font-normal sm:text-lg">{heroEyebrow}</p>
          <h1 className="mt-2 text-3xl font-semibold leading-tight tracking-tight sm:text-5xl md:text-[3.25rem]">
            {heroTitle}
          </h1>
